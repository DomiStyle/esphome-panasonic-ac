...
namespace ESPPAC
{
  namespace WLAN
  {
    ...
    */
    ...
    void PanasonicACWLAN::set_vertical_swing_select(select::Select *vertical_swing_select)
    {
    ...
    void PanasonicACWLAN::set_horizontal_swing_select(select::Select *horizontal_swing_select)
    {
